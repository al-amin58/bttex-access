                        ...
                        <div class="tab-pane fade show active" id="v-pills-app" role="tabpanel" aria-labelledby="v-pills-app-tab" tabindex="0">
                            ...
                            <div>
                                <form class="form form-vertical" @submit.prevent="updateBuisnessSetting()">
                                    ...
                                    <div class="row"> 
                                        <div class="p-3 col-6">
                                            <label for="name" class="d-block mb-2 text-dark">App Url</label>
                                            <input id="name"  :value="$page.props.setting.app_url" type="text" class="bt-border p-2 rounded w-100 bg-danger-soft" readonly>
