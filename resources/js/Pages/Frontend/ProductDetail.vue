<script setup>
    ...
    const shareOptions = {
        url: `https://btx.ctpse.info/${props.product.slug}`,
        text:`https://btx.ctpse.info/${props.product.slug}`,
    }
                ...
                <div class="col-lg-3">
                    <div class="overflow-hidden shadow">
                        <div class="p-3" style="background-color: #031B4E;">
                            <h3 class="text-white p-2 mb-2 text-center" style=" border-block: 1px solid #fff;">Same day delivery or the next day (We Do not have any Delivery Charges)</h3>
                        </div>
                        <div class="p-2">
                            <p class="text-dark fs-4 mb-3 text-center">Special  Discount for Wholesale & Retail Customers</p>
                            ...
                            <div class="d-flex flex-column flex align-items-center py-3">
                                <div class="d-flex align-items-center justify-contain-center gap-2">
                                    <img src="@/assets/images/helpline.png" style="width: 30px; height: 30px;">
                                    <span>Helpline</span>
                                </div>
                                <h3>
                                    <a href="tel:017162284115" class="primary-color">+8801716 284115</a>
                                </h3>
                                <p class="text-secondary fs-6">Call for Order & Other Enquiry</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="product-detail-tab bg-white border">
                ...
                <div class="tab-content p-lg-5" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-review" role="tabpanel" aria-labelledby="pills-review-tab" tabindex="0">
                        ...
                        <div class="py-3 py-lg-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
                    ...
                    <div class="tab-pane fade " id="pills-qa" role="tabpanel" aria-labelledby="pills-qa-tab" tabindex="0">
                        ...
                        <h3 class="mb-4">Questions About This Product ( {{ product?.questions?.length }} )</h3>
        ...
        <div class="container pb-5">
            ...
            <div>
                ...
                <Swiper
                        ...
                        class="mySwiper"
                    >
                        <SwiperSlide v-for="product in relatedProducts"  :key="product?.id" class="h-100">
